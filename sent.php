...
?>
	...
	<script>
	//this is to hide daft tab if the user has hidden it in the settings
		$(document).ready(function(){
	...
	<!-- this is the side tabs bar for navigation -->
		...
		<div class="col-4 col-m-4" style="height:82vh; overflow-y:auto; overflow-x:hidden;background-color:rgb(165, 165, 165,0.7); margin-left:3%;display:block; ">
			<?php
				...
				//to return the sent mail items from the sent database for the logged in user
				$sql= "SELECT * FROM ".$user."_sent ORDER BY id DESC";
