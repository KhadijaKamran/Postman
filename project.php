...
?>
	...
	<script>
		//this is to hide starred tab if the user has hidden it in the settings
		$(document).ready(function(){
...
<body style="font-family:Calibri; color:rgb(240,240,240);padding:0% ;margin:0%; width:98%;background-color:rgb(40,1,22); background-image:url('newflip1.jpg');background-repeat:no-repeat;background-size:cover; background-position:center; display:block;height:100%;">
		...
		<div class="col-1 col-m-1" style="color:white; padding-top:1%;display:block; height:100%;">
			...
			<div class="col-11 col-m-5" style="height:20%;padding-top:1px;">
				<form action="SearchInbox.php" onsubmit="handle">
					<input type="text" name="Search" placeholder="Search" style="width:80%; height:25px">
				</form>
				<script>
				//This is to detect enter has been pressed
				    function handle(e){
	...
	<div class="col-1 col-m-1 " style="color:white;height:100%;display:block;">
		...
		<div class="col-4 col-m-4" style="height:82vh; overflow-y:auto; overflow-x:hidden;background-color:rgb(165, 165, 165,0.9); margin-left:3%;display:block; ">
			...
			<?php
				...
				//selecting all the recieved mails of the user from the database and display
				$sql= "SELECT * FROM ".$user."_inbox ORDER BY id DESC";
